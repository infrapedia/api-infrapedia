...
module.exports = {
  ...
  associationsFacilitiesKU: (id) => Organization.associationsFacilitiesKU(id),
  ...
  updateKnownUserFacility: (usr, idOrganization, idFacility, operation) => Organization.updateKnownUserFacility(usr, idOrganization, idFacility, operation),
