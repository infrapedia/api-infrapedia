                              ...
                              ixp.updateOne({ _id: new ObjectID(ixIid) },
                                {
                                  ...
                                  $set: {
                                    ...
                                    website: body.data[0].proto_ipv6,
                                    url_stats: body.data[0].proto_ipv6,
                                    tech_email: body.data[0].proto_ipv6,
                                    tech_phone: body.data[0].proto_ipv6,
                                    policy_email: body.data[0].proto_ipv6,
                                    policy_phone: body.data[0].proto_ipv6,
                                    media: body.data[0].proto_ipv6,
                                  },
                                }, (err, ixu) => {
